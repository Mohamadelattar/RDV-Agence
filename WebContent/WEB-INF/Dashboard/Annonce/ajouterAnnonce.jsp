            ...
            <div class="signupForm-ontainer mx-auto px-3 px-sm-0">
			 	<div class="card card-5">
				    <div class="card-heading">
				        <h2 class="title">Ajouter Annonce</h2>
				    </div>
				    <div class="card-body">
				        <form method="POST"  action="dash-annonce?action=enregistrer"  enctype="multipart/form-data">
				            ...
				            <div class="form-row">
				            	...
				            	<div class="value custom-file">
							      	<input type="file" class="custom-file-input input--style-5" id="image" name="image" value="<c:out value="${annonce.getImage() }"/>">

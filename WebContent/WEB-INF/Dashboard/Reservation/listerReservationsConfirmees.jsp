...
<head>
<meta charset="UTF-8">
<title>Listes des reservations confirmées</title>
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Liste de Reservations confirmes</div>
                                </div>   
					...
					<div class="table100-body js-pscroll">
						<table>
							<c:forEach items="${reservations }" var="reservation">
								<tr class="row100 body res-confirm-oui">
									
									<td class="column2 text-center res-confirm-oui-td"><c:out value="${reservation.idReservation }" /></td>
									
									<td class="column2 text-center res-confirm-oui-td"><c:out value="${reservation.cinClient }" /></td>
									
									<td class="column2 text-center res-confirm-oui-td"><c:out value="${reservation.dateReservation }" /></td>
									
									<td class="column2 text-center res-confirm-oui-td"><c:out value="${reservation.heureReservation }" /></td>
									
									<td class="column2 text-center res-confirm-oui-td">

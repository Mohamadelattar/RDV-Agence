...
public class ValidationReservation {
    ...
    public Reservation creerReservation( HttpServletRequest request, String statut )
            throws Exception {
        ...
        if ( client != null ) {
            System.out.println( "dkhaaaalt" );
            reservation.setIdClient( 2 );
        }
    ...
    public String getClientName( Reservation reservation ) {
        ClientDao clientdao = new ClientDao( Client.class );
        Client client;
        int clientId = reservation.getIdClient();
